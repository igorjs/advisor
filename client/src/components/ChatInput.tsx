...
export function ChatInput({ onSend, disabled }: ChatInputProps) {
  ...
  function doSubmit() {
    ...
    onSend(trimmed);
    setText("");
    // Reset height and keep focus after sending
    ...
    >
      <div className="relative flex-1">
        <textarea
          ...
          disabled={disabled}
          rows={1}
          className="w-full resize-none rounded-xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-900 px-4 py-2.5 pr-10 text-sm leading-relaxed shadow-sm transition-colors placeholder:text-gray-400 dark:placeholder:text-gray-500 focus:border-primary-400 dark:focus:border-primary-600 focus:outline-none focus:ring-2 focus:ring-primary-100 dark:focus:ring-primary-900 disabled:bg-gray-50 dark:disabled:bg-gray-800 disabled:text-gray-500 dark:disabled:text-gray-400"
        />
        {text.length === 0 && (
