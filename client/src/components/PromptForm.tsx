  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-3">
      ...
      <textarea
        ...
        rows={4}
        maxLength={5000}
        className="w-full rounded-lg border border-gray-300 bg-white px-4 py-3 text-sm shadow-sm transition-colors placeholder:text-gray-400 focus:border-primary-500 focus:outline-none focus:ring-1 focus:ring-primary-500 disabled:bg-gray-50 disabled:text-gray-500 dark:border-gray-600 dark:bg-gray-900 dark:placeholder:text-gray-500 dark:focus:border-primary-500 dark:focus:ring-primary-400 dark:disabled:bg-gray-800 dark:disabled:text-gray-400"
      />
